...
// Setelah login, redirect ke dashboard utama
...
// Group route dengan prefix /dashboard
Route::middleware(['auth'])->prefix('dashboard')->group(function () {
    ...
    Route::resource('artikel', ArtikelController::class)->parameters([
        'artikel' => 'slug'
    ]);

    Route::resource('struktur', StrukturController::class)->parameters([
        'struktur' => 'slug'
    ]);
    ...
    Route::resource('surat', SuratController::class)->parameters([
        'surat' => 'slug'
    ]);
