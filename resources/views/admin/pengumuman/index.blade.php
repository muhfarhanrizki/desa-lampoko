<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-50 px-6 py-10">
        ...
        <div class="flex items-center justify-between mb-8 mx-16 px-10">
            <h1 class="text-3xl font-semibold text-gray-800">Daftar Pengumuman</h1>
        ...
        <div class="max-w-7xl mx-auto mb-20 bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tr>
                    ...
                    <th class="px-6 py-4 text-left">Tanggal</th> <!-- Tambah kolom ini -->
                    <th class="px-6 py-4 text-left">Lokasi</th>  <!-- Tambah kolom ini -->
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                @forelse($pengumuman as $item)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-gray-700">{{ \Carbon\Carbon::parse($item->tanggal)->format('d M Y') }}</td> <!-- Tanggal -->
                        <td class="px-6 py-4 text-gray-700">{{ $item->lokasi }}</td> <!-- Lokasi -->
