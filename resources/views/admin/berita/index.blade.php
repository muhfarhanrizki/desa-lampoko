<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-50 px-6 py-10">
        ...
        <div class="flex items-center justify-between mb-8 mx-16 px-10">
            <h1 class="text-3xl font-semibold text-gray-800">Daftar Berita Desa</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-100 text-gray-600 uppercase text-xs font-semibold tracking-wider">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left">Isi Berita</th>
                    ...
                    @forelse($beritas as $berita)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-gray-700">
                                {{ \Illuminate\Support\Str::limit(strip_tags($berita->isi), 60, '...') }}
                            </td>
