<section class="py-20 bg-amber-50 px-4">
    <div class="max-w-6xl mx-auto">
        <div class="grid md:grid-cols-5 gap-4 items-start">
            <div class="md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-4" data-aos="fade-right">
                    @foreach ($produks->take(3) as $produk)
                    <a href="{{ route('produk.frontend.show', $produk->slug) }}" class="block group">
                        <div class="bg-gradient-to-br from-white to-gray-100 border border-gray-200 hover:border-amber-600 rounded-2xl shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300 overflow-hidden h-full flex flex-col">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute top-2 left-2 bg-amber-600 text-white text-xs px-3 py-1 rounded-full shadow">
                                    UMKM
                                </div>
                            </div>
                            ...
                            <div class="p-5 flex flex-col flex-grow">
                                ...
                                <p class="text-sm text-gray-600 mb-4 line-clamp-2 flex-grow">{{ Str::limit(strip_tags($produk->deskripsi), 80) }}</p>

                                <div class="mt-auto flex items-center justify-between pt-2 border-t border-gray-100">
                                    <div class="flex items-center gap-1 text-xs text-amber-600 transition font-medium">
            ...
            <!-- Kanan: Teks -->
            <div class="md:col-span-2 text-left md:text-right" data-aos="fade-left">
            <div class="inline-flex items-center gap-2 px-5 py-2 mb-3 rounded-full bg-gradient-to-r from-amber-400 to-amber-700 text-white text-sm font-semibold mx-auto shadow-lg shadow-amber-400/50">
